...
import { isStripeEvent, isStripeEventEnvelope, StripeEvent, StripeEventEnvelope } from "./stripe/events";

// TODO: refactor into events, requests and response types
...
export type EventTypeLiterals = 'WhatsAppEvent' | 'SQSEvent' | 'APIGatewayProxyEvent' | 'APIGatewayEvent' | 'TextMessage' | 'InteractiveMessage' | 'StripeEvent' | 'StripeEventEnvelope';
export type EventType = WhatsAppEvent | SQSEvent | APIGatewayProxyEvent | APIGatewayEvent | TextMessageEvent | InteractiveMessageEvent | StripeEvent | StripeEventEnvelope;
...
export const eventIdentifiers: EventIdentifiers = {
    ...
    StripeEvent: isStripeEvent,
    StripeEventEnvelope: isStripeEventEnvelope
};
